...
exports.MenuRow = (0, react_1.memo)(({ index, style, data }) => {
    ...
    return (React.createElement("div", { style: style },
        React.createElement(Component, { option: option, labelComponent: labelComponent, height: rowHeight, active: currentValue.some(val => (0, utils_1.equal)(val, option.value, equalCompareProp)), selected: selectedIndex === index, search: search, onSelect: onSelect })));
