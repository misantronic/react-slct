...
exports.MenuRow = react_1.memo(({ index, style, data }) => {
    const { options = [], labelComponent, selectedIndex, optionComponent, rowHeight, search, onSelect } = data;
    const option = options[index];
    const currentValue = utils_1.isArray(data.value) ? data.value : [data.value];
    const Component = optionComponent || option_1.OptionComponent;
    return (React.createElement("div", { style: style },
        React.createElement(Component, { option: option, labelComponent: labelComponent, height: rowHeight, active: currentValue.some(val => utils_1.equal(val, option.value)), selected: selectedIndex === index, search: search, onSelect: onSelect })));
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
//# sourceMappingURL=react-slct.js.map?tm=1563231438158
});
...
//# sourceMappingURL=react-slct.js.map?tm=1565820392612