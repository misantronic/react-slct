...
class Value extends React.PureComponent {
    ...
    renderValues(valueOptions) {
        ...
        return valueOptions.map(option => multi ? (React.createElement(Multi, { key: utils_1.toString(option.value), option: option, labelComponent: labelComponent, options: valueOptions, onRemove: this.props.onOptionRemove })) : (React.createElement(Single, { key: utils_1.toString(option.value), option: option, labelComponent: labelComponent })));
    }
    focus() {
...
//# sourceMappingURL=react-slct.js.map?tm=1539181242366
});
...
class MenuContainer extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { ref: this.onEl, style: {
            ...
            ? react_dom_1.createPortal(React.createElement(Menu.MenuContainer, { "data-role": "menu", className: "react-slct-menu", error: error, rect: this.state.rect, menuWidth: menuWidth, menuHeight: menuHeight }, children), this.document.body)
            : null));
    }
    addListener() {
        if (this.window) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
//# sourceMappingURL=react-slct.js.map?tm=1542294761602
});
...
//# sourceMappingURL=react-slct.js.map?tm=1542295468308