...
class MenuContainer extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { ref: this.onEl, style: {
            ...
            ? react_dom_1.createPortal(React.createElement(Menu.MenuContainer, { "data-role": "menu", className: className, error: error, rect: this.state.rect, menuWidth: menuWidth, menuHeight: menuHeight }, children), this.document.body)
            : null));
    }
    addListener() {
        if (this.window) {
...
//# sourceMappingURL=react-slct.js.map?tm=1547065718198